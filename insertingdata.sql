...
Insert into clinical_Data (PatientID, Age, Gender, Treatment, EfficacyScore, SideEffect, BloodPressure, DateVisited, BMI, Cholesterol, SmokingStatus, DiabetesStatus, FamilyHistory, Ethnicity, EducationLevel, Occupation)
Values
